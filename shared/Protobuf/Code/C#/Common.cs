  ...
  public static partial class CommonReflection {
    ...
    static CommonReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "Cgxjb21tb24ucHJvdG8SC0NsaWVudFByb3RvIksKDlJhbmtQbGF5ZXJJbmZv",
            "EgoKAmlkGAEgASgJEgwKBG5hbWUYAiABKAkSEQoJaGVhZEltYWdlGAMgASgJ",
            "EgwKBHJhbmsYBCABKAUiIwoISXRlbUluZm8SCgoCaWQYASABKAUSCwoDbnVt",
            "GAIgASgDKnoKCFBsYXRmb3JtEgsKB1VOS05PV04QABIGCgJXWBABEgYKAlFR",
            "EAISBgoCVFQQAxIICgRWSVZPEAQSCAoET1BQTxAFEgYKAktTEAYSCAoESk9Z",
            "TxAHEgYKAkhXEAgSBwoDWmZiEAkSBwoDWGhzEAoSCQoEQkVUQRDnByrvBQoO",
            "RUh0dHBFcnJvckNvZGUSBwoDTmlsEAASCwoHU3VjY2VzcxABEhIKDVBhcmFt",
            "c0ludmFsaWQQkU4SDgoJU3lzdGVtRXJyEJJOEhEKDFVuYXV0aG9yaXplZBCT",
            "ThIQCgtEYXRhYmFzZUVychCUThIRCgxVc2VyTm90TG9naW4QlU4SEAoLVXNl",
            "clNpZ25FcnIQlk4SFAoPVXNlck5vdEV4aXN0RXJyEJdOEhgKE1VzZXJBbHJl",
            "YWR5RXhpc3RFcnIQmE4SFQoQSnNvblVubWFyc2hhbEVychCZThIPCgpEZWNy",
            "eXB0RXJyEJpOEhYKEVNvY2tldE5vdEV4aXN0RXJyEJtOEhwKF0FkVmlkZW9P",
            "dXRPZk1heFRpbWVzRXJyEJxOEhQKD1N5c3RlbVVubG9ja0VychCdThIOCglD",
            "b25maWdFcnIQnk4SEgoNQ29udGVudFNlY0VychCfThIWChFTZXJ2ZXJOb3RT",
            "ZXJ2ZUVychCgThILCgZOb0RhdGEQoU4SFAoPTG9naW5WZXJzaW9uRXJyEKJO",
            "EhQKD05vTWF0Y2hQbGF5SW5mbxCjThIQCgtKV1RUb2tlbkVychCkThIZChRK",
            "V1RUb2tlbk91dE9mRGF0ZUVychClThIZChRKV1RUb2tlblVJRERlY29kZUVy",
            "chCmThIYChNKV1RUb2tlbk1vZGlmaWVkRXJyEKdOEhIKDVRvb01hbnlSZXFF",
            "cnIQqE4SEwoOU2FtZUFzQ2FjaGVFcnIQqU4SEAoLSW50ZXJuYWxFcnIQqk4S",
            "GAoTUGxhdGZvcm1Ob3RSaWdodEVychCrThIPCgpBY2NvdW50RXJyEKxOEhgK",
            "E0NsaWVudFZlcnNpb25Mb3dFcnIQrU4SGAoTV3hTZXNzaW9uS2V5SW52YWxp",
            "ZBCuThIYChNXeFNlc3Npb25LZXlOb3RGaW5kEK9OEhAKC1Jlc3BEYXRhRXJy",
            "ELBOEhgKE1BsYXRmb3JtTm90RXhpc3RFcnIQsU5CFVoTLi9wcm90b2J1Zjtw",
            "cm90b2J1ZmIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::ClientProto.Platform), typeof(global::ClientProto.EHttpErrorCode), }, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::ClientProto.RankPlayerInfo), global::ClientProto.RankPlayerInfo.Parser, new[]{ "Id", "Name", "HeadImage", "Rank" }, null, null, null, null),

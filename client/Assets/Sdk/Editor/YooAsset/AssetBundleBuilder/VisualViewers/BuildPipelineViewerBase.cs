    ...
    internal abstract class BuildPipelineViewerBase
    {
        ...
        private void CreateView(VisualElement parent)
        {
            ...
            // 构建模式
            {
                ...
                // 暂时不需要这个选择构建模式, 隐藏
                buildModeContainer.style.display = DisplayStyle.None;
            ...
            // 加密方法
            {
                ...
                // 暂时不需要这个, 隐藏
                encryptionContainer.style.display = DisplayStyle.None;
            ...
            // 暂时不需要这个, 隐藏
            _compressionField.style.display = DisplayStyle.None;
            ...
            // 暂时不需要这个, 隐藏
            _outputNameStyleField.style.display = DisplayStyle.None;
            ...
            // 暂时不需要这个, 隐藏
            _copyBuildinFileOptionField.style.display = DisplayStyle.None;
        ...
        {
            var buildMode = AssetBundleBuilderSetting.GetPackageBuildMode(PackageName, BuildPipeline);
            if (true || EditorUtility.DisplayDialog("提示", $"通过构建模式【{buildMode}】来构建！", "Yes", "No"))
            {

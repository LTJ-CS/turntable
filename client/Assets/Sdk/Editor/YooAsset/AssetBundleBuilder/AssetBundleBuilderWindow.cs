...
namespace YooAsset.Editor
{
    ...
    {
        // [MenuItem("YooAsset/AssetBundle Builder", false, 102)] // 暂时不再需要这个功能, 我们有自己的构建 UI
        ...
        private void RefreshBuildPipelineView()
        {
            ...
            var buildTarget = EditorUserBuildSettings.activeBuildTarget;if (_buildPipeline == EBuildPipeline.ScriptableBuildPipeline)
            {
